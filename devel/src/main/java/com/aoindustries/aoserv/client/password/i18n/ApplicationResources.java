...
package com.aoindustries.aoserv.client.password.i18n;
...
public final class ApplicationResources extends EditableResourceBundle {
	...
	static File getSourceFile(String filename) {
		try {
			return new File(System.getProperty("user.home") + "/maven2/ao/aoserv/client/src/main/resources/com/aoindustries/aoserv/client/password/i18n", filename);
