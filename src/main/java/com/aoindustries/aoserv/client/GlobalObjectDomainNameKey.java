...
public abstract class GlobalObjectDomainNameKey<T extends GlobalObjectDomainNameKey<T>> extends GlobalObject<DomainName, T> {
   ...
   *
   * @see  GlobalObjectDomainNameKey#init(java.sql.ResultSet)
   * @see  GlobalObjectDomainNameKey#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
