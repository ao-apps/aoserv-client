 ...
 * Copyright (C) 2019, 2021, 2022, 2023, 2025  AO Industries, Inc.
...
public final class NoticeLogBalance extends CachedObjectIntegerKey<NoticeLogBalance> {
   ...
   *
   * @see  NoticeLogBalance#init(java.sql.ResultSet)
   * @see  NoticeLogBalance#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
