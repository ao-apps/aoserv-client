...
public final class Currency extends GlobalObjectStringKey<Currency> {
   ...
   *
   * @see  Currency#init(java.sql.ResultSet)
   * @see  Currency#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
