...
final public class BusinessServer extends CachedObjectIntegerKey<BusinessServer> implements Removable {
	...
	public List<CannotRemoveReason<?>> getCannotRemoveReasons() throws SQLException, IOException {
		...
		List<Business> bus=table.getConnector().getBusinesses().getRows();
	...
	public void remove() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.REMOVE, SchemaTable.TableID.BUSINESS_SERVERS, pkey);
	}
