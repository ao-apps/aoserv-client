...
public final class Administrator extends CachedObjectUserNameKey<Administrator> implements PasswordProtected, Removable, Disablable, Comparable<Administrator> {
   ...
   *
   * @see  Administrator#init(java.sql.ResultSet)
   * @see  Administrator#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
  ...
  public User getUsername() throws SQLException, IOException {
    ...
    if (usernameObject == null) {
      throw new SQLException("Username not found: " + pkey);
    }
   ...
   * Sorts by username.
   *
   * <p>TODO: Consider handling comparisons at the AoservTable and making all
