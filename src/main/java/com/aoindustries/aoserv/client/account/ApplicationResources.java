...
public final class ApplicationResources extends EditableResourceBundle {
	...
	public ApplicationResources() {
		super(
			Locale.ROOT,
			bundleSet,
			new File(System.getProperty("user.home")+"/maven2/ao/aoserv/client/src/main/resources/com/aoindustries/aoserv/client/account/ApplicationResources.properties")
		);
	}
