...
public final class Profile extends CachedObjectIntegerKey<Profile> {
   ...
   *
   * @see  Profile#init(java.sql.ResultSet)
   * @see  Profile#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
