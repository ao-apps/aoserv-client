...
final public class Business extends CachedObjectAccountingCodeKey<Business> implements Disablable, Comparable<Business> {
	...
	public void disable(DisableLog dl) throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.DISABLE, SchemaTable.TableID.BUSINESSES, dl.getPkey(), pkey.toString());
	}

	@Override
	public void enable() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.ENABLE, SchemaTable.TableID.BUSINESSES, pkey.toString());
	}
	...
	public void move(AOServer from, AOServer to, TerminalWriter out) throws IOException, SQLException {
		...
		{
			for(LinuxServerGroup lsg : table.getConnector().getLinuxServerGroups().getRows()) {
		...
		{
			List<LinuxServerAccount> lsas=table.getConnector().getLinuxServerAccounts().getRows();
