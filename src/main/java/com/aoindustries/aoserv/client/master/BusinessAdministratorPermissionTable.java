...
final public class BusinessAdministratorPermissionTable extends CachedTableIntegerKey<BusinessAdministratorPermission> {
	...
	public BusinessAdministratorPermissionTable(AOServConnector connector) {
	...
	public List<BusinessAdministratorPermission> getPermissions(BusinessAdministrator ba) throws IOException, SQLException {
		return getIndexedRows(BusinessAdministratorPermission.COLUMN_USERNAME, ba.getUsername_userId());
	}
	...
	public boolean hasPermission(BusinessAdministrator ba, String permission) throws IOException, SQLException {
		synchronized(this) {
