...
public final class Action extends CachedObjectIntegerKey<Action> {
   ...
   *
   * @see  Action#init(java.sql.ResultSet)
   * @see  Action#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
