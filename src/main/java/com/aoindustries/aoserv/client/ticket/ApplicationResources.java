...
public final class ApplicationResources extends EditableResourceBundle {
	...
	public ApplicationResources() {
		super(
			new Locale(""),
			bundleSet,
			new File(System.getProperty("user.home")+"/maven2/ao/aoserv/client/src/main/resources/com/aoindustries/aoserv/client/ticket/ApplicationResources.properties")
		);
	}
