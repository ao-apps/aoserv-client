...
public final class Ticket extends CachedObjectIntegerKey<Ticket> {
   ...
   *
   * @see  Ticket#init(java.sql.ResultSet)
   * @see  Ticket#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
