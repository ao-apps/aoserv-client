...
public final class Priority extends GlobalObjectStringKey<Priority> implements Comparable<Priority> {
   ...
   *
   * @see  Priority#init(java.sql.ResultSet)
   * @see  Priority#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
