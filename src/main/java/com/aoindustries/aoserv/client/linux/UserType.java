 ...
 *
 * <p>TODO: Make this class an enum?  How would API version compatibility work?  Same for group type.</p>
 *
 * @see  User
 * @see  UserServer
 *
...
public final class UserType extends GlobalObjectStringKey<UserType> {
   ...
   *
   * @see  UserType#init(java.sql.ResultSet)
   * @see  UserType#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
