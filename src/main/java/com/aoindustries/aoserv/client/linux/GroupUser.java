 ...
 * Copyright (C) 2000-2009, 2014, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2025  AO Industries, Inc.
...
public final class GroupUser extends CachedObjectIntegerKey<GroupUser> implements Removable {
   ...
   *
   * @see  GroupUser#init(java.sql.ResultSet)
   * @see  GroupUser#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
