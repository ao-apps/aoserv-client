	...
	implements DtoFactory<com.aoindustries.aoserv.client.dto.AOServer>
{
	...
	public NetBind getDaemonBind() throws IOException, SQLException {
		...
		// May be filtered
		return table.getConnector().getNetBinds().get(daemon_bind);
	}
	...
	public AOServer getFailoverServer() throws SQLException, IOException {
		...
		AOServer se=table.getConnector().getAoServers().get(failover_server);
	...
	public NetDeviceID getDaemonDeviceId() throws SQLException, IOException {
		NetDeviceID obj = table.getConnector().getNetDeviceIDs().get(daemonDeviceId);
	...
	public NetBind getDaemonConnectBind() throws IOException, SQLException {
		...
		// May be filtered
		return table.getConnector().getNetBinds().get(daemon_connect_bind);
	}
	...
	public TimeZone getTimeZone() throws SQLException, IOException {
		TimeZone obj = table.getConnector().getTimeZones().get(time_zone);
	...
	public NetBind getJilterBind() throws IOException, SQLException {
		...
		// May be filtered
		return table.getConnector().getNetBinds().get(jilter_bind);
	}
	...
	public int addCvsRepository(
		...
		return table.getConnector().getCvsRepositories().addCvsRepository(
			this,
			path,
			lsa,
			lsg,
	...
	public int addEmailDomain(DomainName domain, Package packageObject) throws SQLException, IOException {
		return table.getConnector().getEmailDomains().addEmailDomain(domain, this, packageObject);
	}

	public int addEmailPipe(String command, Package packageObject) throws IOException, SQLException {
		return table.getConnector().getEmailPipes().addEmailPipe(this, command, packageObject);
	}
	...
	public int addHttpdJBossSite(
		...
		return table.getConnector().getHttpdJBossSites().addHttpdJBossSite(
			this,
			siteName,
			packageObj,
			siteUser,
	...
	public int addHttpdSharedTomcat(
		...
		return table.getConnector().getHttpdSharedTomcats().addHttpdSharedTomcat(
			name,
			this,
			version,
			lsa,
	...
	public int addHttpdTomcatSharedSite(
		...
		return table.getConnector().getHttpdTomcatSharedSites().addHttpdTomcatSharedSite(
			this,
			siteName,
			packageObj,
			siteUser,
	...
	public int addHttpdTomcatStdSite(
		...
		return table.getConnector().getHttpdTomcatStdSites().addHttpdTomcatStdSite(
			this,
			siteName,
			packageObj,
			jvmUser,
	...
	public int addSystemGroup(GroupId groupName, int gid) throws IOException, SQLException {
		return table.getConnector().getLinuxServerGroups().addSystemGroup(
			this,
			groupName,
			gid
		);
	...
	public int addSystemUser(
		...
		return table.getConnector().getLinuxServerAccounts().addSystemUser(
			this,
			username,
			uid,
			gid,
	...
	public List<AOServerDaemonHost> getAOServerDaemonHosts() throws IOException, SQLException {
		return table.getConnector().getAoServerDaemonHosts().getAOServerDaemonHosts(this);
	}

	public List<BackupPartition> getBackupPartitions() throws IOException, SQLException {
		return table.getConnector().getBackupPartitions().getBackupPartitions(this);
	}

	public BackupPartition getBackupPartitionForPath(String path) throws IOException, SQLException {
		return table.getConnector().getBackupPartitions().getBackupPartitionForPath(this, path);
	}

	public List<BlackholeEmailAddress> getBlackholeEmailAddresses() throws IOException, SQLException {
		return table.getConnector().getBlackholeEmailAddresses().getBlackholeEmailAddresses(this);
	}

	public CvsRepository getCvsRepository(UnixPath path) throws IOException, SQLException {
		return table.getConnector().getCvsRepositories().getCvsRepository(this, path);
	}
	...
	public CyrusImapdServer getCyrusImapdServer() throws IOException, SQLException {
		return table.getConnector().getCyrusImapdServers().get(pkey);
	}

	public List<EmailAddress> getEmailAddresses() throws IOException, SQLException {
		return table.getConnector().getEmailAddresses().getEmailAddresses(this);
	}

	public EmailDomain getEmailDomain(DomainName domain) throws IOException, SQLException {
		return table.getConnector().getEmailDomains().getEmailDomain(this, domain);
	}
	...
	public EmailList getEmailList(UnixPath path) throws IOException, SQLException {
		return table.getConnector().getEmailLists().getEmailList(this, path);
	}
	...
	public List<EmailPipeAddress> getEmailPipeAddresses() throws IOException, SQLException {
		return table.getConnector().getEmailPipeAddresses().getEmailPipeAddresses(this);
	}
	...
	public EmailSmtpRelay getEmailSmtpRelay(Package pk, HostAddress host) throws IOException, SQLException {
		return table.getConnector().getEmailSmtpRelays().getEmailSmtpRelay(pk, this, host);
	}
	...
	public List<FTPGuestUser> getFTPGuestUsers() throws IOException, SQLException {
		return table.getConnector().getFtpGuestUsers().getFTPGuestUsers(this);
	}
	...
	public HttpdSharedTomcat getHttpdSharedTomcat(String jvmName) throws IOException, SQLException {
		return table.getConnector().getHttpdSharedTomcats().getHttpdSharedTomcat(jvmName, this);
	}

	public HttpdSite getHttpdSite(String siteName) throws IOException, SQLException {
		return table.getConnector().getHttpdSites().getHttpdSite(siteName, this);
	}
	...
	public LinuxServerAccount getLinuxServerAccount(UserId username) throws IOException, SQLException {
		return table.getConnector().getLinuxServerAccounts().getLinuxServerAccount(this, username);
	}

	public LinuxServerAccount getLinuxServerAccount(LinuxId uid) throws IOException, SQLException {
		return table.getConnector().getLinuxServerAccounts().getLinuxServerAccount(this, uid);
	}
	...
	public LinuxServerGroup getLinuxServerGroup(LinuxId gid) throws IOException, SQLException {
		return table.getConnector().getLinuxServerGroups().getLinuxServerGroup(this, gid);
	}

	public LinuxServerGroup getLinuxServerGroup(GroupId groupName) throws IOException, SQLException {
		return table.getConnector().getLinuxServerGroups().getLinuxServerGroup(this, groupName);
	}
	...
	public List<MajordomoServer> getMajordomoServers() throws IOException, SQLException {
		return table.getConnector().getMajordomoServers().getMajordomoServers(this);
	}
	...
	public MySQLServer getMySQLServer(MySQLServerName name) throws IOException, SQLException {
		return table.getConnector().getMysqlServers().getMySQLServer(name, this);
	}

	public List<MySQLServer> getMySQLServers() throws IOException, SQLException {
		return table.getConnector().getMysqlServers().getMySQLServers(this);
	}
	...
	public List<AOServer> getNestedAOServers() throws IOException, SQLException {
		return table.getConnector().getAoServers().getNestedAOServers(this);
	}

	public PostgresServer getPostgresServer(PostgresServerName name) throws IOException, SQLException {
		return table.getConnector().getPostgresServers().getPostgresServer(name, this);
	}

	public List<PostgresServer> getPostgresServers() throws IOException, SQLException {
		return table.getConnector().getPostgresServers().getPostgresServers(this);
	}
	...
	public List<PrivateFTPServer> getPrivateFTPServers() throws IOException, SQLException {
		return table.getConnector().getPrivateFTPServers().getPrivateFTPServers(this);
	}
	...
	public List<SystemEmailAlias> getSystemEmailAliases() throws IOException, SQLException {
		return table.getConnector().getSystemEmailAliases().getSystemEmailAliases(this);
	}
	...
	public boolean isEmailDomainAvailable(DomainName domain) throws SQLException, IOException {
		return table.getConnector().getEmailDomains().isEmailDomainAvailable(this, domain);
	}

	public boolean isHomeUsed(UnixPath directory) throws IOException, SQLException {
		return table.getConnector().getLinuxServerAccounts().isHomeUsed(this, directory);
	}

	public boolean isMySQLServerNameAvailable(MySQLServerName name) throws IOException, SQLException {
		return table.getConnector().getMysqlServers().isMySQLServerNameAvailable(name, this);
	}

	public boolean isPostgresServerNameAvailable(PostgresServerName name) throws IOException, SQLException {
		return table.getConnector().getPostgresServers().isPostgresServerNameAvailable(name, this);
	}
	...
	public void startDistro(boolean includeUser) throws IOException, SQLException {
		table.getConnector().getDistroFiles().startDistro(this, includeUser);
	}
