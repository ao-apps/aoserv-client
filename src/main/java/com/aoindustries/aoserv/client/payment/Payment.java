...
public final class Payment extends CachedObjectIntegerKey<Payment> {
   ...
   *
   * @see  Payment#init(java.sql.ResultSet)
   * @see  Payment#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
  ...
  public CountryCode getShippingCountryCode() throws SQLException, IOException {
    ...
    if (cc == null) {
      throw new SQLException("Unable to find CountryCode: " + shippingCountryCode);
    }
    return cc;
  }
  ...
  public Administrator getCreditCardCreatedBy() throws SQLException, IOException {
    ...
    if (administrator == null) {
      throw new SQLException("Unable to find Administrator: " + creditCardCreatedBy);
    }
  ...
  public Account getCreditCardAccount() throws SQLException, IOException {
    ...
    if (business == null) {
      throw new SQLException("Unable to find Account: " + creditCardAccounting);
    }
    return business;
  }
  ...
  public CountryCode getCreditCardCountryCode() throws SQLException, IOException {
    ...
    if (cc == null) {
      throw new SQLException("Unable to find CountryCode: " + creditCardCountryCode);
    }
    return cc;
  }
  ...
  public Administrator getAuthorizationAdministrator() throws SQLException, IOException {
    ...
    if (administrator == null) {
      throw new SQLException("Unable to find Administrator: " + authorizationUsername);
    }
    return administrator;
  }
  ...
  public Administrator getVoidAdministrator() throws SQLException, IOException {
    ...
    if (administrator == null) {
      throw new SQLException("Unable to find Administrator: " + voidUsername);
    }
    return administrator;
  }
  ...
  public void saleCompleted(
    ...
    if (!table.getConnector().isSecure()) {
      throw new IOException("Credit card transactions may only be updated when using secure protocols.  Currently using the " + table.getConnector().getProtocol() + " protocol, which is not secure.");
    }
