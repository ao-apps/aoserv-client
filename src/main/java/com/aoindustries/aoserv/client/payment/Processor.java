 ...
 * Copyright (C) 2007-2013, 2016, 2017, 2018, 2019, 2021, 2022, 2025  AO Industries, Inc.
...
public final class Processor extends CachedObjectStringKey<Processor> {
   ...
   *
   * @see  Processor#init(java.sql.ResultSet)
   * @see  Processor#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
