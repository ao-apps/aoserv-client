...
final public class CreditCardTransaction extends CachedObjectIntegerKey<CreditCardTransaction> {
	...
	public CountryCode getShippingCountryCode() throws SQLException, IOException {
		...
		CountryCode cc = table.getConnector().getCountryCodes().get(shippingCountryCode);
	...
	public BusinessAdministrator getCreditCardCreatedBy() throws SQLException, IOException {
		BusinessAdministrator business_administrator = table.getConnector().getBusinessAdministrators().get(creditCardCreatedBy);
	...
	public Business getCreditCardBusiness() throws SQLException, IOException {
		Business business = table.getConnector().getBusinesses().get(creditCardAccounting);
	...
	public CountryCode getCreditCardCountryCode() throws SQLException, IOException {
		CountryCode cc = table.getConnector().getCountryCodes().get(creditCardCountryCode);
	...
	public BusinessAdministrator getAuthorizationAdministrator() throws SQLException, IOException {
		...
		BusinessAdministrator business_administrator = table.getConnector().getBusinessAdministrators().get(authorizationUsername);
	...
	public BusinessAdministrator getCaptureAdministrator() throws SQLException, IOException {
		...
		BusinessAdministrator business_administrator = table.getConnector().getBusinessAdministrators().get(captureUsername);
	...
	public BusinessAdministrator getVoidAdministrator() throws SQLException, IOException {
		...
		BusinessAdministrator business_administrator = table.getConnector().getBusinessAdministrators().get(voidUsername);
