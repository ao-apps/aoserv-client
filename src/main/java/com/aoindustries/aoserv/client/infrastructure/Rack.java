 ...
 * Copyright (C) 2008, 2009, 2016, 2017, 2018, 2019, 2021, 2022, 2025  AO Industries, Inc.
...
public final class Rack extends CachedObjectIntegerKey<Rack> {
   ...
   *
   * @see  Rack#init(java.sql.ResultSet)
   * @see  Rack#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
