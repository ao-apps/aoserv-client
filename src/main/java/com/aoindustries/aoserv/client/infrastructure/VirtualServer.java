...
public final class VirtualServer extends CachedObjectIntegerKey<VirtualServer> {
   ...
   *
   * @see  VirtualServer#init(java.sql.ResultSet)
   * @see  VirtualServer#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
