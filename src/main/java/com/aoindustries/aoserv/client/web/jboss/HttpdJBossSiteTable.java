...
final public class HttpdJBossSiteTable extends CachedTableIntegerKey<HttpdJBossSite> {
	...
	public HttpdJBossSiteTable(AOServConnector connector) {
		super(connector, HttpdJBossSite.class);
	}

	private static final OrderBy[] defaultOrderBy = {
		new OrderBy(HttpdJBossSite.COLUMN_TOMCAT_SITE_name+'.'+HttpdTomcatSite.COLUMN_HTTPD_SITE_name+'.'+HttpdSite.COLUMN_NAME_name, ASCENDING),
	...
	public HttpdJBossSite getHttpdJBossSiteByRMIPort(NetBind nb) throws IOException, SQLException {
		int pkey=nb.getId();
	...
	public HttpdJBossSite getHttpdJBossSiteByJNPPort(NetBind nb) throws IOException, SQLException {
		int pkey=nb.getId();
	...
	public HttpdJBossSite getHttpdJBossSiteByWebserverPort(NetBind nb) throws IOException, SQLException {
		int pkey=nb.getId();
	...
	public HttpdJBossSite getHttpdJBossSiteByHypersonicPort(NetBind nb) throws IOException, SQLException {
		int pkey=nb.getId();
	...
	public HttpdJBossSite getHttpdJBossSiteByJMXPort(NetBind nb) throws IOException, SQLException {
		int pkey=nb.getId();
