...
/**
 * Each {@link HttpdSiteBind} may have header configurations attached to it.
 ...
 */
final public class HttpdSiteBindHeader extends CachedObjectIntegerKey<HttpdSiteBindHeader> {
	...
	public HttpdSiteBind getHttpdSiteBind() throws SQLException, IOException {
		HttpdSiteBind obj = table.getConnector().getHttpdSiteBinds().get(httpd_site_bind);
