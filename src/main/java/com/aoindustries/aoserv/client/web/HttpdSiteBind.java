...
final public class HttpdSiteBind extends CachedObjectIntegerKey<HttpdSiteBind> implements Disablable {
	...
	public HttpdSite getHttpdSite() throws SQLException, IOException {
		HttpdSite obj = table.getConnector().getHttpdSites().get(httpd_site);
	...
	public HttpdBind getHttpdBind() throws SQLException, IOException {
		HttpdBind obj = table.getConnector().getHttpdBinds().get(httpd_bind);
	...
	public void disable(DisableLog dl) throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.DISABLE, SchemaTable.TableID.HTTPD_SITE_BINDS, dl.getPkey(), pkey);
	}

	@Override
	public void enable() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.ENABLE, SchemaTable.TableID.HTTPD_SITE_BINDS, pkey);
	}
	...
	public List<HttpdSiteURL> getHttpdSiteURLs() throws IOException, SQLException {
		return table.getConnector().getHttpdSiteURLs().getHttpdSiteURLs(this);
	}

	public HttpdSiteURL getPrimaryHttpdSiteURL() throws SQLException, IOException {
		return table.getConnector().getHttpdSiteURLs().getPrimaryHttpdSiteURL(this);
	}

	public List<HttpdSiteURL> getAltHttpdSiteURLs() throws IOException, SQLException {
		return table.getConnector().getHttpdSiteURLs().getAltHttpdSiteURLs(this);
	}

	public int addHttpdSiteURL(DomainName hostname) throws IOException, SQLException {
		return table.getConnector().getHttpdSiteURLs().addHttpdSiteURL(this, hostname);
	}
