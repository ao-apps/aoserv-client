...
final public class HttpdSiteTable extends CachedTableIntegerKey<HttpdSite> {
	...
	public HttpdSiteTable(AOServConnector connector) {
	...
	public HttpdSite getHttpdSite(String siteName, AOServer ao) throws IOException, SQLException {
	...
	public List<HttpdSite> getHttpdSites(AOServer ao) throws IOException, SQLException {
		return getIndexedRows(HttpdSite.COLUMN_AO_SERVER, ao.getPkey());
	}

	public List<HttpdSite> getHttpdSites(Package pk) throws IOException, SQLException {
		return getIndexedRows(HttpdSite.COLUMN_PACKAGE, pk.getName());
	}

	public List<HttpdSite> getHttpdSites(LinuxServerAccount lsa) throws IOException, SQLException {
