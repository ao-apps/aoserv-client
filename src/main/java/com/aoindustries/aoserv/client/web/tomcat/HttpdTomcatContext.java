...
final public class HttpdTomcatContext extends CachedObjectIntegerKey<HttpdTomcatContext> implements Removable {
	...
	public int addHttpdTomcatDataSource(
		...
		return table.getConnector().getHttpdTomcatDataSources().addHttpdTomcatDataSource(
			this,
			name,
			driverClassName,
			url,
	...
	public int addHttpdTomcatParameter(String name, String value, boolean override, String description) throws IOException, SQLException {
		return table.getConnector().getHttpdTomcatParameters().addHttpdTomcatParameter(this, name, value, override, description);
	}
	...
	public HttpdTomcatSite getHttpdTomcatSite() throws SQLException, IOException {
		HttpdTomcatSite obj=table.getConnector().getHttpdTomcatSites().get(tomcat_site);
	...
	public List<HttpdTomcatDataSource> getHttpdTomcatDataSources() throws IOException, SQLException {
		return table.getConnector().getHttpdTomcatDataSources().getHttpdTomcatDataSources(this);
	}

	public HttpdTomcatDataSource getHttpdTomcatDataSource(String name) throws IOException, SQLException {
		return table.getConnector().getHttpdTomcatDataSources().getHttpdTomcatDataSource(this, name);
	}

	public List<HttpdTomcatParameter> getHttpdTomcatParameters() throws IOException, SQLException {
		return table.getConnector().getHttpdTomcatParameters().getHttpdTomcatParameters(this);
	}

	public HttpdTomcatParameter getHttpdTomcatParameter(String name) throws IOException, SQLException {
		return table.getConnector().getHttpdTomcatParameters().getHttpdTomcatParameter(this, name);
	}
	...
	public void remove() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.REMOVE, SchemaTable.TableID.HTTPD_TOMCAT_CONTEXTS, pkey);
	}
