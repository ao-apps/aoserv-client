...
final public class HttpdSiteURLTable extends CachedTableIntegerKey<HttpdSiteURL> {
	...
	public HttpdSiteURLTable(AOServConnector connector) {
		super(connector, HttpdSiteURL.class);
	}

	private static final OrderBy[] defaultOrderBy = {
		new OrderBy(HttpdSiteURL.COLUMN_HOSTNAME_name, ASCENDING),
		new OrderBy(HttpdSiteURL.COLUMN_HTTPD_SITE_BIND_name+'.'+HttpdSiteBind.COLUMN_HTTPD_SITE_name+'.'+HttpdSite.COLUMN_NAME_name, ASCENDING),
		...
		new OrderBy(HttpdSiteURL.COLUMN_HTTPD_SITE_BIND_name+'.'+HttpdSiteBind.COLUMN_HTTPD_BIND_name+'.'+HttpdBind.COLUMN_NET_BIND_name+'.'+NetBind.COLUMN_IP_ADDRESS_name+'.'+IPAddress.COLUMN_DEVICE_name+'.'+NetDevice.COLUMN_DEVICE_ID_name, ASCENDING),
	...
	List<HttpdSiteURL> getHttpdSiteURLs(HttpdSiteBind bind) throws IOException, SQLException {
		return getIndexedRows(HttpdSiteURL.COLUMN_HTTPD_SITE_BIND, bind.getPkey());
	}
