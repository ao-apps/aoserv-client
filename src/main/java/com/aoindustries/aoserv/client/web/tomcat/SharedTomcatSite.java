...
public final class SharedTomcatSite extends CachedObjectIntegerKey<SharedTomcatSite> {
   ...
   *
   * @see  SharedTomcatSite#init(java.sql.ResultSet)
   * @see  SharedTomcatSite#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
