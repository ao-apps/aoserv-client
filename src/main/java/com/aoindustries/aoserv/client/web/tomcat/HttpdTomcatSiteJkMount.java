...
final public class HttpdTomcatSiteJkMount extends CachedObjectIntegerKey<HttpdTomcatSiteJkMount> implements Removable {
	...
	public HttpdTomcatSite getHttpdTomcatSite() throws SQLException, IOException {
		HttpdTomcatSite obj = table.getConnector().getHttpdTomcatSites().get(httpd_tomcat_site);
	...
	public void remove() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.REMOVE, SchemaTable.TableID.HTTPD_TOMCAT_SITE_JK_MOUNTS, pkey);
	}
