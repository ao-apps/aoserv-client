...
final public class HttpdTomcatDataSource extends CachedObjectIntegerKey<HttpdTomcatDataSource> implements Removable {
	...
	public HttpdTomcatContext getHttpdTomcatContext() throws SQLException, IOException {
		HttpdTomcatContext obj=table.getConnector().getHttpdTomcatContexts().get(tomcat_context);
	...
	public void remove() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.REMOVE, SchemaTable.TableID.HTTPD_TOMCAT_DATA_SOURCES, pkey);
	}
