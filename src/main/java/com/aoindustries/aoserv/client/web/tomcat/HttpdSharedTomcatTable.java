...
final public class HttpdSharedTomcatTable extends CachedTableIntegerKey<HttpdSharedTomcat> {
	...
	public  HttpdSharedTomcatTable(AOServConnector connector) {
	...
	public HttpdSharedTomcat getHttpdSharedTomcat(HttpdWorker hw) throws SQLException, IOException {
		return getUniqueRow(HttpdSharedTomcat.COLUMN_TOMCAT4_WORKER, hw.getPkey());
	}

	public HttpdSharedTomcat getHttpdSharedTomcatByShutdownPort(NetBind nb) throws SQLException, IOException {
		return getUniqueRow(HttpdSharedTomcat.COLUMN_TOMCAT4_SHUTDOWN_PORT, nb.getId());
	}

	public List<HttpdSharedTomcat> getHttpdSharedTomcats(LinuxServerAccount lsa) throws IOException, SQLException {
		return getIndexedRows(HttpdSharedTomcat.COLUMN_LINUX_SERVER_ACCOUNT, lsa.getPkey());
	}

	public List<HttpdSharedTomcat> getHttpdSharedTomcats(Package pk) throws IOException, SQLException {
	...
	public List<HttpdSharedTomcat> getHttpdSharedTomcats(AOServer ao) throws IOException, SQLException {
		return getIndexedRows(HttpdSharedTomcat.COLUMN_AO_SERVER, ao.getPkey());
	}

	public HttpdSharedTomcat getHttpdSharedTomcat(String name, AOServer ao) throws IOException, SQLException {
		// Use the index first
