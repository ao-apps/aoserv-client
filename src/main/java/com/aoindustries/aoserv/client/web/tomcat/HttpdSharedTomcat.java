...
final public class HttpdSharedTomcat extends CachedObjectIntegerKey<HttpdSharedTomcat> implements Disablable, Removable {
	...
	public static final String DEFAULT_TOMCAT_VERSION_PREFIX = HttpdTomcatVersion.VERSION_9_0_PREFIX;
	...
	public void disable(DisableLog dl) throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.DISABLE, SchemaTable.TableID.HTTPD_SHARED_TOMCATS, dl.getPkey(), pkey);
	}

	@Override
	public void enable() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.ENABLE, SchemaTable.TableID.HTTPD_SHARED_TOMCATS, pkey);
	}
	...
	public List<HttpdTomcatSharedSite> getHttpdTomcatSharedSites() throws IOException, SQLException {
		return table.getConnector().getHttpdTomcatSharedSites().getHttpdTomcatSharedSites(this);
	}

	public HttpdTomcatVersion getHttpdTomcatVersion() throws SQLException, IOException {
		HttpdTomcatVersion obj=table.getConnector().getHttpdTomcatVersions().get(version);
	...
	public LinuxServerAccount getLinuxServerAccount() throws SQLException, IOException {
		LinuxServerAccount obj=table.getConnector().getLinuxServerAccounts().get(linux_server_account);
	...
	public LinuxServerGroup getLinuxServerGroup() throws SQLException, IOException {
		LinuxServerGroup obj=table.getConnector().getLinuxServerGroups().get(linux_server_group);
	...
	public HttpdWorker getTomcat4Worker() throws SQLException, IOException {
		...
		HttpdWorker hw=table.getConnector().getHttpdWorkers().get(tomcat4_worker);
	...
	public NetBind getTomcat4ShutdownPort() throws IOException, SQLException {
		...
		NetBind nb=table.getConnector().getNetBinds().get(tomcat4_shutdown_port);
	...
	public void remove() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.REMOVE, SchemaTable.TableID.HTTPD_SHARED_TOMCATS, pkey);
	}
