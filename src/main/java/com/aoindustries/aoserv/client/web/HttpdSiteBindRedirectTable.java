...
final public class HttpdSiteBindRedirectTable extends CachedTableIntegerKey<HttpdSiteBindRedirect> {
	...
	public HttpdSiteBindRedirectTable(AOServConnector connector) {
		super(connector, HttpdSiteBindRedirect.class);
	}

	private static final OrderBy[] defaultOrderBy = {
		new OrderBy(HttpdSiteBindRedirect.COLUMN_HTTPD_SITE_BIND_name + '.' + HttpdSiteBind.COLUMN_HTTPD_SITE_name + '.' + HttpdSite.COLUMN_NAME_name, ASCENDING),
		...
		new OrderBy(HttpdSiteBindRedirect.COLUMN_HTTPD_SITE_BIND_name + '.' + HttpdSiteBind.COLUMN_HTTPD_BIND_name + '.' + HttpdBind.COLUMN_NET_BIND_name + '.' + NetBind.COLUMN_IP_ADDRESS_name + '.' + IPAddress.COLUMN_DEVICE_name + '.' + NetDevice.COLUMN_DEVICE_ID_name, ASCENDING),
	...
	List<HttpdSiteBindRedirect> getHttpdSiteBindRedirects(HttpdSiteBind bind) throws IOException, SQLException {
		return getIndexedRows(HttpdSiteBindRedirect.COLUMN_HTTPD_SITE_BIND, bind.getPkey());
	}
