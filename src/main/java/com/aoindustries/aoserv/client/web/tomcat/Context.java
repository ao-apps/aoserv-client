...
public final class Context extends CachedObjectIntegerKey<Context> implements Removable {
   ...
   *
   * @see  Context#init(java.sql.ResultSet)
   * @see  Context#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
