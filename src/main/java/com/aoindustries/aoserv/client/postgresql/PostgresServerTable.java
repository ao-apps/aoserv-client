...
final public class PostgresServerTable extends CachedTableIntegerKey<PostgresServer> {
	...
	public PostgresServerTable(AOServConnector connector) {
	...
	public PostgresServer getPostgresServer(NetBind nb) throws IOException, SQLException {
		return getUniqueRow(PostgresServer.COLUMN_BIND, nb.getId());
	}

	public List<PostgresServer> getPostgresServers(AOServer ao) throws IOException, SQLException {
		return getIndexedRows(PostgresServer.COLUMN_AO_SERVER, ao.getPkey());
	}

	public PostgresServer getPostgresServer(PostgresServerName name, AOServer ao) throws IOException, SQLException {
		// Use the index first
	...
	public boolean isPostgresServerNameAvailable(PostgresServerName name, AOServer ao) throws IOException, SQLException {
