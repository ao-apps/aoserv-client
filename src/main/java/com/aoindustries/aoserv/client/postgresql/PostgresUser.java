...
final public class PostgresUser extends CachedObjectPostgresUserIdKey<PostgresUser> implements Removable, PasswordProtected, Disablable {
	...
	public boolean canDisable() throws IOException, SQLException {
		...
		for(PostgresServerUser psu : getPostgresServerUsers()) if(!psu.isDisabled()) return false;
		return true;
	}
	...
	public void disable(DisableLog dl) throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.DISABLE, SchemaTable.TableID.POSTGRES_USERS, dl.getPkey(), pkey);
	}

	@Override
	public void enable() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.ENABLE, SchemaTable.TableID.POSTGRES_USERS, pkey);
	}
