...
public final class Brand extends CachedObjectAccountNameKey<Brand> {
   ...
   *
   * @see  Brand#init(java.sql.ResultSet)
   * @see  Brand#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
