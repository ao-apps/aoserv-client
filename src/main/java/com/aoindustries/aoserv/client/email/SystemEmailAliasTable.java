...
final public class SystemEmailAliasTable extends CachedTableIntegerKey<SystemEmailAlias> {
	...
	public SystemEmailAliasTable(AOServConnector connector) {
	...
	public List<SystemEmailAlias> getSystemEmailAliases(AOServer ao) throws IOException, SQLException {
		return getIndexedRows(SystemEmailAlias.COLUMN_AO_SERVER, ao.getPkey());
	}
