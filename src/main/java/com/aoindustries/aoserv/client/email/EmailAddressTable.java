...
final public class EmailAddressTable extends CachedTableIntegerKey<EmailAddress> {
	...
	public EmailAddressTable(AOServConnector connector) {
	...
	public int addEmailAddress(String address, EmailDomain domainObject) throws SQLException, IOException {
	...
	public EmailAddress getEmailAddress(String address, EmailDomain domain) throws IOException, SQLException {
	...
	List<EmailAddress> getEmailAddresses(EmailDomain domain) throws IOException, SQLException {
		return getIndexedRows(EmailAddress.COLUMN_DOMAIN, domain.getPkey());
	}

	public List<EmailAddress> getEmailAddresses(AOServer ao) throws IOException, SQLException {
