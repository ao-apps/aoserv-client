...
final public class EmailListAddressTable extends CachedTableIntegerKey<EmailListAddress> {
	...
	public EmailListAddressTable(AOServConnector connector) {
	...
	List<EmailListAddress> getEmailListAddresses(EmailList list) throws IOException, SQLException {
		return getIndexedRows(EmailListAddress.COLUMN_EMAIL_LIST, list.getPkey());
	}
	...
	List<EmailListAddress> getEmailListAddresses(EmailAddress ea) throws IOException, SQLException {
		return getIndexedRows(EmailListAddress.COLUMN_EMAIL_ADDRESS, ea.getPkey());
	}
	...
	public List<EmailListAddress> getEmailListAddresses(AOServer ao) throws IOException, SQLException {
