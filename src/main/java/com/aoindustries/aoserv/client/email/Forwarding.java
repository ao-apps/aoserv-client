 ...
 * Copyright (C) 2000-2013, 2016, 2017, 2018, 2019, 2021, 2022, 2023, 2025  AO Industries, Inc.
...
public final class Forwarding extends CachedObjectIntegerKey<Forwarding> implements Removable {
   ...
   *
   * @see  Forwarding#init(java.sql.ResultSet)
   * @see  Forwarding#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
