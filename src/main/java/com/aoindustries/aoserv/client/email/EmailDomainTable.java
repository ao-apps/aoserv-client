...
public final class EmailDomainTable extends CachedTableIntegerKey<EmailDomain> {
	...
	public EmailDomainTable(AOServConnector connector) {
	...
	public int addEmailDomain(DomainName domain, AOServer ao, Package packageObject) throws SQLException, IOException {
	...
	public List<EmailDomain> getEmailDomains(Business owner) throws SQLException, IOException {
	...
	public List<EmailDomain> getEmailDomains(Package pack) throws IOException, SQLException {
		return getIndexedRows(EmailDomain.COLUMN_PACKAGE, pack.getName());
	}

	public List<EmailDomain> getEmailDomains(AOServer ao) throws IOException, SQLException {
		return getIndexedRows(EmailDomain.COLUMN_AO_SERVER, ao.getServer_pkey());
	}

	public EmailDomain getEmailDomain(AOServer ao, DomainName domain) throws IOException, SQLException {
		// Use the index first
	...
	public boolean isEmailDomainAvailable(AOServer aoServer, DomainName domain) throws SQLException, IOException {
