...
public final class EmailSmtpSmartHostTable extends CachedTableIntegerKey<EmailSmtpSmartHost> {
	...
	public EmailSmtpSmartHostTable(AOServConnector connector) {
	...
	private static final OrderBy[] defaultOrderBy = {
		...
		new OrderBy(EmailSmtpSmartHost.COLUMN_NET_BIND_name+'.'+NetBind.COLUMN_IP_ADDRESS_name+'.'+IPAddress.COLUMN_DEVICE_name+'.'+NetDevice.COLUMN_DEVICE_ID_name, ASCENDING),
