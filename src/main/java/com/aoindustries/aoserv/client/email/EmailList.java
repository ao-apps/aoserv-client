...
final public class EmailList extends CachedObjectIntegerKey<EmailList> implements Removable, Disablable {
	...
	public void disable(DisableLog dl) throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.DISABLE, SchemaTable.TableID.EMAIL_LISTS, dl.getPkey(), pkey);
	}

	@Override
	public void enable() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.ENABLE, SchemaTable.TableID.EMAIL_LISTS, pkey);
	}
	...
	public LinuxServerAccount getLinuxServerAccount() throws SQLException, IOException {
		LinuxServerAccount linuxServerAccountObject = table.getConnector().getLinuxServerAccounts().get(linux_server_account);
	...
	public LinuxServerGroup getLinuxServerGroup() throws SQLException, IOException {
		LinuxServerGroup linuxServerGroupObject = table.getConnector().getLinuxServerGroups().get(linux_server_group);
