...
public final class EmailSmtpSmartHostDomainTable extends CachedTableIntegerKey<EmailSmtpSmartHostDomain> {
	...
	public EmailSmtpSmartHostDomainTable(AOServConnector connector) {
	...
	private static final OrderBy[] defaultOrderBy = {
		...
		new OrderBy(EmailSmtpSmartHostDomain.COLUMN_SMART_HOST_name+'.'+EmailSmtpSmartHost.COLUMN_NET_BIND_name+'.'+NetBind.COLUMN_IP_ADDRESS_name+'.'+IPAddress.COLUMN_DEVICE_name+'.'+NetDevice.COLUMN_DEVICE_ID_name, ASCENDING),
