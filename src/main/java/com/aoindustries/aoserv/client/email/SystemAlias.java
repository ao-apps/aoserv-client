...
public final class SystemAlias extends CachedObjectIntegerKey<SystemAlias> {
   ...
   *
   * @see  SystemAlias#init(java.sql.ResultSet)
   * @see  SystemAlias#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
