...
public final class EmailSmtpRelay extends CachedObjectIntegerKey<EmailSmtpRelay> implements Removable, Disablable {
	...
	public int addSpamEmailMessage(String message) throws IOException, SQLException {
		return table.getConnector().getSpamEmailMessages().addSpamEmailMessage(this, message);
	}
	...
	public void disable(DisableLog dl) throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.DISABLE, SchemaTable.TableID.EMAIL_SMTP_RELAYS, dl.getPkey(), pkey);
	}

	@Override
	public void enable() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.ENABLE, SchemaTable.TableID.EMAIL_SMTP_RELAYS, pkey);
	}
	...
	public EmailSmtpRelayType getType() throws SQLException, IOException {
		EmailSmtpRelayType esrt=table.getConnector().getEmailSmtpRelayTypes().get(type);
	...
	public List<SpamEmailMessage> getSpamEmailMessages() throws IOException, SQLException {
		return table.getConnector().getSpamEmailMessages().getSpamEmailMessages(this);
	}
