...
public final class EmailAttachmentBlockTable extends CachedTableIntegerKey<EmailAttachmentBlock> {
	...
	public EmailAttachmentBlockTable(AOServConnector connector) {
	...
	public List<EmailAttachmentBlock> getEmailAttachmentBlocks(LinuxServerAccount lsa) throws IOException, SQLException {
		return getIndexedRows(EmailAttachmentBlock.COLUMN_LINUX_SERVER_ACCOUNT, lsa.getPkey());
	}
