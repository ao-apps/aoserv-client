...
final public class LinuxAccAddressTable extends CachedTableIntegerKey<LinuxAccAddress> {
	...
	public LinuxAccAddressTable(AOServConnector connector) {
	...
	public int addLinuxAccAddress(EmailAddress emailAddressObject, LinuxServerAccount lsa) throws IOException, SQLException {
	...
	public List<EmailAddress> getEmailAddresses(LinuxServerAccount lsa) throws SQLException, IOException {
	...
	public List<LinuxAccAddress> getLinuxAccAddresses(LinuxServerAccount lsa) throws IOException, SQLException {
		return getIndexedRows(LinuxAccAddress.COLUMN_LINUX_SERVER_ACCOUNT, lsa.getPkey());
	}
	...
	public List<LinuxAccAddress> getLinuxAccAddresses(AOServer ao) throws IOException, SQLException {
	...
	List<LinuxAccAddress> getLinuxAccAddresses(EmailAddress address) throws IOException, SQLException {
		return getIndexedRows(LinuxAccAddress.COLUMN_EMAIL_ADDRESS, address.getPkey());
	}
