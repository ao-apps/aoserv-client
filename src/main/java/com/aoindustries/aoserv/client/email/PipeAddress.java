...
public final class PipeAddress extends CachedObjectIntegerKey<PipeAddress> implements Removable {
   ...
   *
   * @see  PipeAddress#init(java.sql.ResultSet)
   * @see  PipeAddress#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
