...
public final class EmailSmtpRelayTable extends CachedTableIntegerKey<EmailSmtpRelay> {
	...
	public EmailSmtpRelayTable(AOServConnector connector) {
	...
	public int addEmailSmtpRelay(final Package pack, final AOServer aoServer, final HostAddress host, final EmailSmtpRelayType type, final long duration) throws IOException, SQLException {
	...
	public EmailSmtpRelay getEmailSmtpRelay(Package pk, AOServer ao, HostAddress host) throws IOException, SQLException {
	...
	public List<EmailSmtpRelay> getEmailSmtpRelays(Package pk) throws IOException, SQLException {
		return getIndexedRows(EmailSmtpRelay.COLUMN_PACKAGE, pk.getName());
	}

	public List<EmailSmtpRelay> getEmailSmtpRelays(AOServer ao) throws IOException, SQLException {
		int aoPKey=ao.getPkey();
