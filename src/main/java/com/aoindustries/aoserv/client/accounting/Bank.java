...
public final class Bank extends CachedObjectStringKey<Bank> {
   ...
   *
   * @see  Bank#init(java.sql.ResultSet)
   * @see  Bank#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
