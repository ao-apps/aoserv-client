...
public final class Certificate extends CachedObjectIntegerKey<Certificate> {
   ...
   *
   * @see  Certificate#init(java.sql.ResultSet)
   * @see  Certificate#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
