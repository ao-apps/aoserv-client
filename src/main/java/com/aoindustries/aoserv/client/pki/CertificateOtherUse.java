 ...
 */
final public class CertificateOtherUse extends CachedObjectIntegerKey<CertificateOtherUse> {
	...
	public Certificate getSslCertificate() throws SQLException, IOException {
		Certificate obj = table.getConnector().getSslCertificates().get(sslCertificate);
