...
final public class DNSZone extends CachedObjectStringKey<DNSZone> implements Removable, Dumpable {
	...
	public int addDNSRecord(
		...
		return table.getConnector().getDnsRecords().addDNSRecord(this, domain, type, priority, weight, port, destination, ttl);
	}
	...
	public DNSType[] getAllowedDNSTypes() throws IOException, SQLException {
		DNSTypeTable tt=table.getConnector().getDnsTypes();
		if(isArpa()) {
			DNSType[] types={
				tt.get(DNSType.NS),
				tt.get(DNSType.PTR)
	...
	public List<DNSRecord> getDNSRecords() throws IOException, SQLException {
		return table.getConnector().getDnsRecords().getDNSRecords(this);
	}

	public List<DNSRecord> getDNSRecords(String domain, DNSType type) throws IOException, SQLException {
		return table.getConnector().getDnsRecords().getDNSRecords(this, domain, type);
	}
	...
	public void remove() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.REMOVE, SchemaTable.TableID.DNS_ZONES, pkey);
	}
