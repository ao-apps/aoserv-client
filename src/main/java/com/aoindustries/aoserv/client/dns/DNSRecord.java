...
final public class DNSRecord extends CachedObjectIntegerKey<DNSRecord> implements Removable {
	...
	public DNSZone getZone() throws SQLException, IOException {
		DNSZone obj = table.getConnector().getDnsZones().get(zone);
	...
	public DNSType getType() throws SQLException, IOException {
		DNSType obj = table.getConnector().getDnsTypes().get(type);
	...
	public void remove() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.REMOVE, SchemaTable.TableID.DNS_RECORDS, pkey);
	}
