    ...
    return connector.requestResult(
      ...
      new AOServConnector.ResultRequest<Integer>() {
        ...
        public void writeRequest(StreamableOutput out) throws IOException {
          ...
          out.writeBoolean(business_fax != null); if (business_fax != null) {
            out.writeUTF(business_fax);
          }
          out.writeUTF(business_address1);
          out.writeBoolean(business_address2 != null); if (business_address2 != null) {
            out.writeUTF(business_address2);
          }
          out.writeUTF(business_city);
          out.writeBoolean(business_state != null); if (business_state != null) {
            out.writeUTF(business_state);
          }
          out.writeUTF(business_country.getCode());
          out.writeBoolean(business_zip != null); if (business_zip != null) {
            out.writeUTF(business_zip);
          }
          out.writeUTF(ba_name);
          out.writeBoolean(ba_title != null); if (ba_title != null) {
            out.writeUTF(ba_title);
          }
          out.writeUTF(ba_work_phone);
          out.writeBoolean(ba_cell_phone != null); if (ba_cell_phone != null) {
            out.writeUTF(ba_cell_phone);
          }
          out.writeBoolean(ba_home_phone != null); if (ba_home_phone != null) {
            out.writeUTF(ba_home_phone);
          }
          out.writeBoolean(ba_fax != null); if (ba_fax != null) {
            out.writeUTF(ba_fax);
          }
          out.writeUTF(ba_email.toString());
          out.writeBoolean(ba_address1 != null); if (ba_address1 != null) {
            out.writeUTF(ba_address1);
          }
          out.writeBoolean(ba_address2 != null); if (ba_address2 != null) {
            out.writeUTF(ba_address2);
          }
          out.writeBoolean(ba_city != null); if (ba_city != null) {
            out.writeUTF(ba_city);
          }
          out.writeBoolean(ba_state != null); if (ba_state != null) {
            out.writeUTF(ba_state);
          }
          out.writeBoolean(ba_country != null); if (ba_country != null) {
            out.writeUTF(ba_country.getCode());
          }
          out.writeBoolean(ba_zip != null); if (ba_zip != null) {
            out.writeUTF(ba_zip);
          }
          ...
          for (String name : options.keySet()) {
            ...
            out.writeBoolean(value != null); if (value != null) {
              out.writeUTF(value);
            }
            optionCount++;
          }
