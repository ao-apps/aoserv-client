...
public final class FileReplicationSchedule extends CachedObjectIntegerKey<FileReplicationSchedule> {
   ...
   *
   * @see  FileReplicationSchedule#init(java.sql.ResultSet)
   * @see  FileReplicationSchedule#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
