...
final public class NetBindFirewalldZoneTable extends CachedTableIntegerKey<NetBindFirewalldZone> {
	...
	NetBindFirewalldZoneTable(AOServConnector connector) {
	...
	private static final OrderBy[] defaultOrderBy = {
		...
		new OrderBy(NetBindFirewalldZone.COLUMN_NET_BIND_name + '.' + NetBind.COLUMN_IP_ADDRESS_name + '.' + IPAddress.COLUMN_NET_DEVICE_name + '.' + NetDevice.COLUMN_DEVICE_ID_name, ASCENDING),
	...
	List<NetBindFirewalldZone> getNetBindFirewalldZones(NetBind nb) throws IOException, SQLException {
		return getIndexedRows(NetBindFirewalldZone.COLUMN_NET_BIND, nb.pkey);
	}
	...
	List<NetBindFirewalldZone> getNetBindFirewalldZones(FirewalldZone fz) throws IOException, SQLException {
		return getIndexedRows(NetBindFirewalldZone.COLUMN_FIREWALLD_ZONE, fz.pkey);
	}
