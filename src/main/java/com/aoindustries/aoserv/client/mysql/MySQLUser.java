...
final public class MySQLUser extends CachedObjectMySQLUserIdKey<MySQLUser> implements PasswordProtected, Removable, Disablable {
	...
	public boolean canDisable() throws IOException, SQLException {
		...
		for(MySQLServerUser msu : getMySQLServerUsers()) if(!msu.isDisabled()) return false;
		return true;
	}
	...
	public void disable(DisableLog dl) throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.DISABLE, SchemaTable.TableID.MYSQL_USERS, dl.getPkey(), pkey);
	}

	@Override
	public void enable() throws IOException, SQLException {
		table.getConnector().requestUpdateIL(true, AOServProtocol.CommandID.ENABLE, SchemaTable.TableID.MYSQL_USERS, pkey);
	}
