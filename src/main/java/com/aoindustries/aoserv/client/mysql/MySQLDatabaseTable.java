...
final public class MySQLDatabaseTable extends CachedTableIntegerKey<MySQLDatabase> {
	...
	public MySQLDatabaseTable(AOServConnector connector) {
	...
	public List<MySQLDatabase> getMySQLDatabases(Package pack) throws IOException, SQLException {
		return getIndexedRows(MySQLDatabase.COLUMN_PACKAGE, pack.getName());
	}

	List<MySQLDatabase> getMySQLDatabases(MySQLServer ms) throws IOException, SQLException {
		return getIndexedRows(MySQLDatabase.COLUMN_MYSQL_SERVER, ms.getBind_id());
	}
