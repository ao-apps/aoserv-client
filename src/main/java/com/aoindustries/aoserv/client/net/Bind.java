...
public final class Bind extends CachedObjectIntegerKey<Bind> implements Removable {
   ...
   *
   * @see  Bind#init(java.sql.ResultSet)
   * @see  Bind#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
