...
final public class NetBindTable extends CachedTableIntegerKey<NetBind> {
	...
	public NetBindTable(AOServConnector connector) {
	...
	List<NetBind> getNetBinds(IPAddress ia) throws IOException, SQLException {
		return getIndexedRows(NetBind.COLUMN_IP_ADDRESS, ia.getPkey());
	}

	public List<NetBind> getNetBinds(Package pk) throws IOException, SQLException {
		return getIndexedRows(NetBind.COLUMN_PACKAGE, pk.getName());
	}

	public List<NetBind> getNetBinds(Package pk, IPAddress ip) throws IOException, SQLException {
	...
	List<NetBind> getNetBinds(Server se) throws IOException, SQLException {
		return getIndexedRows(NetBind.COLUMN_SERVER, se.getPkey());
	}
