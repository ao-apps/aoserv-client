...
public final class NetTcpRedirectTable extends CachedTableIntegerKey<NetTcpRedirect> {
	...
	public NetTcpRedirectTable(AOServConnector connector) {
	...
	private static final OrderBy[] defaultOrderBy = {
		...
		new OrderBy(NetTcpRedirect.COLUMN_NET_BIND_name+'.'+NetBind.COLUMN_IP_ADDRESS_name+'.'+IPAddress.COLUMN_DEVICE_name+'.'+NetDevice.COLUMN_DEVICE_ID_name, ASCENDING),
