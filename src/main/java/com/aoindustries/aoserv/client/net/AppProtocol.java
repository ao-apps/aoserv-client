...
public final class AppProtocol extends GlobalObjectStringKey<AppProtocol> {
   ...
   *
   * @see  AppProtocol#init(java.sql.ResultSet)
   * @see  AppProtocol#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
