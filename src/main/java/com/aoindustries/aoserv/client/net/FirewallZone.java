...
public final class FirewallZone extends CachedObjectIntegerKey<FirewallZone> {
  ...
  public static final class Name implements
    ...
    public static ValidationResult validate(String name) {
      ...
      if (slashPos != -1 && name.indexOf('/', slashPos + 1) != -1) {
  ...
  static {
    try {
      ...
      NM_SHARED = Name.valueOf("nm-shared");
   ...
   *
   * @see  FirewallZone#init(java.sql.ResultSet)
   * @see  FirewallZone#read(com.aoapps.hodgepodge.io.stream.StreamableInput, com.aoindustries.aoserv.client.schema.AoservProtocol.Version)
   */
