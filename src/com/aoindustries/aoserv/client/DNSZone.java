...
final public class DNSZone extends CachedObjectStringKey<DNSZone> implements Removable, Dumpable {
    ...
    private static void printRecord(String linePrefix, StringBuilder line, PrintWriter out, String domain, int ttl, int recordTtl, String type, int mx, String destination) {
	...
	line.append("@                       ").append(ttl).append(" IN   SOA     ");
        ...
        if(firstNS==null) {
            ...
            printLine(line, out);
            printRecord("", line, out, "@", ttl, DNSRecord.NO_TTL, DNSType.NS, DNSRecord.NO_MX_PRIORITY, "ns1.aoindustries.com.");
            printRecord("", line, out, "@", ttl, DNSRecord.NO_TTL, DNSType.NS, DNSRecord.NO_MX_PRIORITY, "ns2.aoindustries.com.");
            printRecord("", line, out, "@", ttl, DNSRecord.NO_TTL, DNSType.NS, DNSRecord.NO_MX_PRIORITY, "ns3.aoindustries.com.");
            printRecord("", line, out, "@", ttl, DNSRecord.NO_TTL, DNSType.NS, DNSRecord.NO_MX_PRIORITY, "ns4.aoindustries.com.");
        }
