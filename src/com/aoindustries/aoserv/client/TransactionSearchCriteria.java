...
final public class TransactionSearchCriteria implements Streamable {
	...
	business=in.readBoolean()?in.readUTF():null;
        sourceBusiness=in.readBoolean()?in.readUTF():null;
	business_administrator=in.readBoolean()?in.readUTF():null;
	type=in.readBoolean()?in.readUTF():null;
	description=in.readBoolean()?in.readUTF():null;
	paymentType=in.readBoolean()?in.readUTF():null;
	paymentInfo=in.readBoolean()?in.readUTF():null;
