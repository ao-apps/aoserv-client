...
public final class EmailSmtpSmartHostTable extends CachedTableIntegerKey<EmailSmtpSmartHost> {
    ...
    private static final OrderBy[] defaultOrderBy = {
        new OrderBy(EmailSmtpSmartHost.COLUMN_NET_BIND_name+'.'+NetBind.COLUMN_BUSINESS_SERVER_name+'.'+BusinessServer.COLUMN_SERVER_name+'.'+Server.COLUMN_ACCOUNTING_name, ASCENDING),
        new OrderBy(EmailSmtpSmartHost.COLUMN_NET_BIND_name+'.'+NetBind.COLUMN_BUSINESS_SERVER_name+'.'+BusinessServer.COLUMN_SERVER_name+'.'+Server.COLUMN_NAME_name, ASCENDING),
