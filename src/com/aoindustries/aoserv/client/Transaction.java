...
final public class Transaction extends AOServObjectIntegerKey implements Comparable<Transaction>, DtoFactory<com.aoindustries.aoserv.client.dto.Transaction>, FastExternalizable {
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        try {
            ...
            fastOut.writeFastUTF(paymentType);
            writeNullUTF(fastOut, paymentInfo);
            fastOut.writeFastUTF(processor);
            writeNullInteger(fastOut, creditCardTransaction);
            fastOut.writeByte(status.byteValue);
        } finally {
            fastOut.unwrap();
        }
    }
