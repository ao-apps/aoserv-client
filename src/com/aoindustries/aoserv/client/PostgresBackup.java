...
/**
 * The PostgreSQL database is backed-up to a backup server on a daily basis.
 ...
 */
final public class PostgresBackup extends CachedObjectIntegerKey<PostgresBackup> implements Removable, Dumpable {

    static final int
        COLUMN_PKEY=0,
        COLUMN_POSTGRES_SERVER=3
    ;
	...
	postgres_server=result.getInt(4);
