...
final public class SchemaType extends GlobalObjectIntegerKey<SchemaType> {
    ...
    public static String getString(Object value, int type) throws IllegalArgumentException {
        ...
        switch(type) {
            case ACCOUNTING: return ((AccountingCode)value).toString();
            ...
            case INTERVAL: return StringUtility.getDecimalTimeLengthString(((Long)value).longValue());
            ...
            case GROUP_ID: return ((GroupId)value).toString();
