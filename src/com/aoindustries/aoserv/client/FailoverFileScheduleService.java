...
public interface FailoverFileScheduleService<C extends AOServConnector<C,F>, F extends AOServConnectorFactory<C,F>> extends AOServServiceIntegerKey<C,F,FailoverFileSchedule> {
